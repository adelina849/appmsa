...
<div class="block full">
    ...
    <div class="block-title">
        <h2 class="themed-color-autumn"><i class="gi gi-macbook animation-pulse" style="margin-top: -7px"></i> <strong>INPUT SP NON-BUKU</strong></h2>
...
<script>
    ...
    function SimpanTransaksi() {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/pesanan/form_nonbuku'); ?>",
            type: "POST",
            cache: false,
            data: FormData,
            dataType: 'json',
            success: function(data) {
                if (data.status == 1) {
                    ...
                    $('#ModalFooter').html("<button type='button' class='btn btn-primary' data-dismiss='modal' autofocus>Ok</button>");
                    $('#ModalGue').modal('show');
                    // // window.location.href = "<?php echo site_url('admin/pesanan/form_nonbuku'); ?>";
