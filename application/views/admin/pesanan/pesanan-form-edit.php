...
<div class="block full">
    ...
    <div class="block-title">
        <h2 class="text-info"><i class="fa fa-pencil-square-o animation-pulse" style="margin-top: -7px"></i> <strong>EDIT SP BUKU</strong></h2>
...
<script>
    ...
    function BarisBaru() {
        ...
        Baris += "<input type='text' id='ppn11_barang' name='ppn11_barang[]' class='decimal form-control text-center' placeholder='0' disabled>";
        ...
        Baris += "<input type='text' id='pph21_barang' name='pph21_barang[]' class='decimal form-control text-center' placeholder='0' disabled>";
        Baris += "<span class='input-group-addon'>";
        ...
        Baris += "<input type='text' id='pph23_barang' name='pph23_barang[]' class='decimal form-control text-center' placeholder='0' disabled>";
        Baris += "<span class='input-group-addon'>";
    ...
    function SimpanTransaksi() {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/pesanan/edit/'.$jenis_sp.'/'.$id_pesanan_m); ?>",
            type: "POST",
            cache: false,
            data: FormData,
            dataType: 'json',
            success: function(data) {
                if (data.status == 1) {
                    ...
                    $('#ModalFooter').html("<button type='button' class='btn btn-primary' data-dismiss='modal' autofocus>Ok</button>");
                    $('#ModalGue').modal('show');
                    window.location.href = "<?php echo site_url('admin/pesanan'); ?>";
