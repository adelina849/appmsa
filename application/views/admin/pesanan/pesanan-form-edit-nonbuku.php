...
<div class="block full">
    ...
    <div class="block-title">
        <h2 class="themed-color-autumn"><i class="gi gi-macbook animation-pulse" style="margin-top: -7px"></i> <strong>EDIT SP NON-BUKU</strong></h2>
        <div class="block-options pull-right" style="margin-right: 15px;">
            <a href="<?= site_url('admin/pesanan/non_buku'); ?>" class="" data-toggle="tooltip" title="Daftar Surat Pesanan">
                <i class="fa fa-list-alt"></i> Daftar SP Non-Buku
            </a>
            ...
            <div class="col-lg-4 col-xs-6">
                <div class="input-group">
                    ...
                    <div class="input-date" data-date-format="yyy-mm-dd">
                        ...
                        placeholder="Tanggal Pemesanan" autocomplete="off"
                        value="<?=$tanggal_sp;?>" disabled>
                        <input type="hidden" id="tanggal_pesanan" name="tanggal_pesanan" value="<?=$tanggal_sp;?>">
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-xs-6">
            ...
            <label for="pelanggan"><i class="fa fa-user"></i> Nama Pelanggan</label>
                <select id="pelanggan" name="pelanggan" class="option-line-break" style="width:100%;" placeholder="Nama Pelanggan">
                    ...
                    foreach ($pelanggan as $pelanggans) {
                        ...
                        $selected = (($pelanggans->id == $id_pelanggan) ? 'selected' : '');                    
            ...
            <div class="col-md-6">
                ...
                <select id="mitra" name="mitra" class="option-line-break" style="width:100%;" placeholder="Nama Marketing">
                    ...
                    foreach ($marketing as $marketings) {
                        $selct = (($marketings->id == $id_marketing) ? 'selected' : '');                    

                    ?>
                        <option data-description="<?= 'ID: ' . $marketings->nomor_id; ?>" value="<?= $marketings->id; ?>"  <?=$selct;?>>
            ...
            <div class="col-md-4">
                ...
                <select id="sumber" name="sumber" class="select-select2 select2" style="width:100%;" placeholder="Sumber Dana">
                    ...
                    foreach ($sumber as $sumbers) {
                        $select_smbr = (($sumbers->id == $idsumber_dana) ? 'selected' : '');                    
                    ?>
                        <option value="<?= $sumbers->id; ?>" <?=$select_smbr;?>>
                            <?= $sumbers->sumber_dana; ?>
                        </option>
                    <?php
                    }
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="input-group">
                    ...
                    <select id="sistem_transaksi" name="sistem_transaksi" class="select-select2 select2" style="width:100%;">
                        ...
                        <option value="siplah" <?=($sistem_transaksi=='siplah' ? 'selected':'');?>>SIPLAH</option>
                        <option value="non-siplah" <?=($sistem_transaksi=='non-siplah' ? 'selected':'')?>>NON SIPLAH</option>
                    </select>
                </div>
            </div>
            <div class="col-lg-3 col-xs-6">
                <div class="input-group">
                    ...
                    <select id="sistem_pembayaran" name="sistem_pembayaran" class="select-select2" style="width:100%;">
                        ...
                        <option value="kredit" <?=($sistem_pembayaran=='kredit' ? 'selected':'');?>>KREDIT</option>
                        <option value="tunai" <?=($sistem_pembayaran=='tunai' ? 'selected':'');?>>TUNAI</option>
                    </select>
                </div>
            </div>
            <div class="col-lg-4 col-xs-6">
                <div class="input-group">
                    ...
                    <div class="input-date" data-date-format="yyy-mm-dd">
                        <input type="text" value="<?=$jatuh_tempo;?>" id="tanggal_jatuh_tempo" name="tanggal_jatuh_tempo" class="form-control input-datepicker" data-date-format="yyyy-mm-dd" placeholder="Tanggal Jatuh Tempo" autocomplete="off">
                    </div>
                </div>
            </div>
                ...
                <div class="input-group">
                    ...
                    <select id="tahun_anggaran" name="tahun_anggaran" class="select-select2" style="width:100%;">
                        ...
                        for ($i = $tahun; $i >= 2015; $i--) {
                            $selct_t = (($i == $tahun_anggaran) ? 'selected' : '');   
                        ?>
                            <option value="<?= $i; ?>" <?=$selct_t;?>><?= $i; ?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="input-group">
                    ...
                    <select id="tahap_anggaran" name="tahap_anggaran" class="select-select2" style="width:100%;">
                        ...
                        <?php
                        for ($i = 1; $i <= 5; $i++) {
                            $selct_thp = (($i == $tahap_anggaran) ? 'selected' : '');   

                        ?>
                            <option value="<?= $i; ?>" <?=$selct_thp;?>><?= $i; ?></option>
                    ...
                    <select id="cv_pelaksana" name="cv_pelaksana" class="select-select2" style="width:100%;">
                        ...
                        <?php
                            ...
                            foreach ($pelaksana as $pelaksanas) {
                                $select_p = (($pelaksanas->id == $id_pelaksana) ? 'selected' : '');                    

                            ?>
                                <option data-description="" value="<?= $pelaksanas->id; ?>" <?=$select_p;?>>
                                    <?= $pelaksanas->nama_cv; ?>
                                </option>
                            <?php
                            }
    ...
    <div style="overflow: hidden; overflow-x: auto; ">
        <div class="table-responsive" style="margin:15px 0px 20px 0px; width: 2600px;">        
            <table class="table table-bordered" id='TabelTransaksi' style="width: auto;">
                <thead>
                    <tr class="themed-background-autumn text-light">
                        ...
                        <td class='text-center' style="width: 5%">HPP</td>
                        <td class='text-center' style="width: 5%">Markup</td>
                        <td class='text-center' style="width: 5%">HPP + Markup</td>
                        <td class='text-center' style="width: 5%">Qty</td>
                        <td class='text-center' style="width: 8%">JML Harga</td>
                        <td class='text-center' style="width: 5%">PPN 11</td>
                        <td class='text-center' style="width: 5%">PPH 22</td>
                        <td class='text-center' style="width: 5%">PPH 23</td>
                        <td class='text-center' style="width: 5%">Harga-Pajak</td>
                        <td class='text-center' style="width: 2%">Diskon</td>
                        <td class='text-center' style="width: 10%">Harga-Diskon</td>
                ...
                <?php
                    $dtsp = $this->db->order_by('id_pesanan_d','ASC')->get_where('pesanan_detail', array('id_pesanan_m' => $id_pesanan_m))->result();
                    $i=0;
                    foreach($dtsp as $dt)
                    {
                        ...
                        $kode_barang = (isset($barang[0]->kode_barang) ? $barang[0]->kode_barang : '-');
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type='text' class='form-control' value="<?=$kode_barang;?>" disabled>
                        </td>
                        <td><?=$nama_barang;?></td>

                        <td>
                            <input type='hidden' name='spesifikasi[]'>
                            <span><?=$dt->spesifikasi;?></span>
                        </td>                            

                        <td>
                            <input type='hidden' name='satuan[]' value='<?=$dt->satuan;?>'>
                            <span><?=$dt->satuan;?></span>
                        </td>

                        <td>
                            <input type='text' name='hpp[]' id='hpp' class='decimal form-control text-right' placeholder='0' onkeypress='return check_int(event)' disabled>
                        </td>

                        <td>
                            <input type='text' name='markup[]' id='markup' class='decimal form-control text-center' placeholder='0.0' disabled>
                        </td>

                        <td>
                            <input type='hidden' name='hpp_markup[]' value='<?=$dt->harga_satuan;?>'>
                            <span><?='Rp. '.str_replace(',', '.', number_format($dt->harga_satuan));?></span>
                        </td>
                        
                        <td>
                            <input type='text' class='form-control text-center' id='jumlah_beli' name='jumlah_beli[]' onkeypress='return check_int(event)' value="<?=$dt->jumlah_beli;?>">
                        </td>
                        
                        <td class='text-right'>
                            <input type='hidden' name='sub_total[]' value='<?=$dt->total;?>'>
                            <span><?='Rp. '.str_replace(',', '.', number_format($dt->total))?></span>
                        </td>

                        <td>
                            <div class='input-group'>
                                <input type='hidden' id='ppn11_barang_value' value='<?=$dt->ppn;?>'>
                                <input type='text' id='ppn11_barang' name='ppn11_barang[]' class='decimal form-control text-center' value='<?=$dt->ppn;?>'>
                                <span class='input-group-addon'>
                        ...
                        <td>
                            <div class='input-group'>
                                <input type='hidden' id='pph21_barang_value' value='<?=$dt->pph22;?>'>
                                <input type='text' id='pph21_barang' name='pph21_barang[]' class='decimal form-control text-center' placeholder='0' value='<?=$dt->pph22;?>'>
                                <span class='input-group-addon'>
                        ...
                        <td>
                            <div class='input-group'>
                                <input type='hidden' id='pph23_barang_value' value='<?=$dt->pph23;?>'>
                                <input type='text' id='pph23_barang' name='pph23_barang[]' class='decimal form-control text-center' value='<?=$dt->pph23;?>'>
                                <span class='input-group-addon'>
                        ...
                        <td class='text-right'>
                            <input type='hidden' name='harga_pajak[]' value='<?=$dt->harga_pajak;?>'>
                            <span><?='Rp. '.str_replace(',', '.', number_format($dt->harga_pajak))?></span>
                        </td>

                        <td class='text-right'>
                            <input type='text' class='decimal form-control text-center' id='diskon_barang' name='diskon_barang[]' value='<?=$dt->diskon_barang;?>'>
                            <span>
                                <input type='hidden' id='nilaiDiskon' name='nilai_diskon[]' value='<?=$dt->diskon_nominal;?>'>
                            </span>
                        </td>

                        <td>
                            <input type='hidden' name='harga_diskon[]' value='<?=$dt->harga_diskon;?>'>
                            <span><?='Rp. '.str_replace(',', '.', number_format($dt->harga_diskon));?></span>
                        </td>

                        <td>
                            <a href='#' class='' id='HapusBaris'><i class='fa fa-times btn-xs' style='color:red;'></i></a>
                        </td>
                    </tr>
        ...
        <div class="col-sm-5">
            <form action="#" method="post" class="form-horizontal form-bordered" onsubmit="return false;">
                ...
                <div class="form-group" style="border-bottom:none; padding-bottom:0px">
                    ...
                    <div class="col-md-6">
                        <input type='text' name='cash' id='UangCash' class='form-control' placeholder='0' onkeypress='return check_int(event)' value="<?=$uang_muka;?>">
                    </div>
                </div>
                ...
                <div class="form-group" style="border-bottom:none;">
                    ...
                    <div class="col-md-6">
                        <input type='hidden' id='SisaBayarHidden' class='form-control' value="<?=$sisa_bayar;?>" >
                        <input type='text' id='SisaBayar' class='form-control' value="<?='Rp. '.str_replace(',', '.', number_format($sisa_bayar));?>" disabled>
                    </div>
                </div>
...
<script>
    ...
    function BarisBaru() {
        ...
        Baris += "<td>";
        Baris += "<input type='hidden' name='satuan[]' onkeypress='return check_int(event)'>";
        Baris += "<span></span>";
        Baris += "</td>";

        //hpp
        Baris += "<td>";
        Baris += "<input type='text' name='hpp[]' id='hpp' class='decimal form-control text-right' placeholder='0' onkeypress='return check_int(event)' disabled>";
        Baris += "</td>";

        Baris += "<td>";
        Baris += "<input type='text' name='markup[]' id='markup' class='decimal form-control text-center' placeholder='0.0' disabled>";
        Baris += "</td>";


        Baris += "<td>";
        Baris += "<input type='hidden' name='hpp_markup[]'>";
        Baris += "<span></span>";
        Baris += "</td>";
    ...
    $(document).on('keyup', '#pencarian_kode', function(e) {
        if ($(this).val() !== '') {
            ...
            if (charCode == 40) {
                ...
                $('#TabelTransaksi tbody tr:eq(' + $(this).parent().parent().index() + ') td:nth-child(6) input').removeAttr('disabled').val(0);
                $('#TabelTransaksi tbody tr:eq(' + $(this).parent().parent().index() + ') td:nth-child(7) input').removeAttr('disabled').val(0);

                $('#TabelTransaksi tbody tr:eq(' + $(this).parent().parent().index() + ') td:nth-child(8) input').val(0);
                $('#TabelTransaksi tbody tr:eq(' + $(this).parent().parent().index() + ') td:nth-child(8) span').html(to_rupiah(0));
                ...
                $('#TabelTransaksi tbody tr:eq(' + $(this).parent().parent().index() + ') td:nth-child(12) input').removeAttr('disabled').val(0);
                $('#TabelTransaksi tbody tr:eq(' + $(this).parent().parent().index() + ') td:nth-child(13) input').removeAttr('disabled').val(0);

                $('#TabelTransaksi tbody tr:eq(' + $(this).parent().parent().index() + ') td:nth-child(14) input').val(0);
                $('#TabelTransaksi tbody tr:eq(' + $(this).parent().parent().index() + ') td:nth-child(14) span').html(to_rupiah(0));
    ...
    //INPUT HPP
    $(document).on('keydown', '#hpp', function(e) {
        var charCode = e.which || e.keyCode;
        if (charCode == 9) {
    ...
    $(document).on('keyup', '#hpp', function() {
        ...
        var HargaPokokPembelian = parseInt(Hpp);
        if (HargaPokokPembelian > 0) {
            // //resset markup
            $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(7) input').val(0);

            //var hasil = Math.round(angka / 1000) * 1000;
            //var HppVal = (Math.ceil(HargaPokokPembelian / 1000) * 1000);
            var HppVal = HargaPokokPembelian;
            HargaPokokPembelian = to_rupiah(HppVal);
        } else {
            HargaPokokPembelian = '';
            var HppVal = 0;
        }
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(8) input').val(HppVal);
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(8) span').html(HargaPokokPembelian);

        //enable QTY
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(9) input').removeAttr('disabled').val(1);
        //enable DISKON
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(15) input').removeAttr('disabled').val(0);

        //set harga jual jual /JML HARGA
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(10) input').val(HppVal);
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(10) span').html(HargaPokokPembelian);


        // //resset pajak ppn pph ke 0
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(11) input').val(0);
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(12) input').val(0);
        ...
        $('#TabelTransaksi tbody tr:eq(' + IndexChexbox + ') td:nth-child(12) input').attr('checked', false);;
        $('#TabelTransaksi tbody tr:eq(' + IndexChexbox + ') td:nth-child(13) input').attr('checked', false);;


        //set harga jual jual /JML HARGA
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(14) input').val(HppVal);
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(14) span').html(HargaPokokPembelian);

        // //resset diskon dan nominal diskon ke 0
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(15) input').val(0);
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(15) span input').val(0);


        // //harga - pajak
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(16) input').val(HppVal);
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(16) span').html(HargaPokokPembelian);

        HitungTotalBayar();
    });    

    //INPUT MARKUP
    $(document).on('keydown', '#markup', function(e) {
        var charCode = e.which || e.keyCode;
        if (charCode == 9) {
            var Indexnya = $(this).parent().parent().index() + 1;
            var TotalIndex = $('#TabelTransaksi tbody tr').length;
    ...
    $(document).on('keyup', '#markup', function() {
        ...
        var Hpp = $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(6) input').val();
        var Markup = $(this).val();
        //var KodeBarang = $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(2) input').val();
        //parseFloat
        ...
        if(Markup !=''){
            var HargaPokokPembelian = parseInt(Hpp);
            var PersenMarkup = parseFloat(Markup);

            if (PersenMarkup > 0) {
                //var HPPMarkup = (Math.round(HargaPokokPembelian / 1000) * 1000);
                var HPPMarkup = (Math.ceil(((HargaPokokPembelian / PersenMarkup).toFixed(0)) / 1000) * 1000);
                HargaPokokPembelian = to_rupiah(HPPMarkup);
                HppVal = HPPMarkup;
            } else {
                HargaPokokPembelian = '';
                var HppVal = 0;
    ...
    $(document).on('keyup', '#jumlah_beli', function() {
        ...
        //resset diskon dan nominal diskon ke 0
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(14) input').val(0);
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(14) span input').val(0);
        ...
        //harga - diskon
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(16) input').val(SubTotalVal);
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(16) span').html(SubTotal);
    ...
    function AutoCompleteGue(Lebar, KataKunci, Indexnya) {
        ...
        if (jenis_barang == '') {
            ...
            $.ajax({
                url: "<?php echo site_url('admin/pesanan/cari_kode'); ?>",
                type: "POST",
                cache: false,
                ...
                success: function(json) {
                    ...
                    if (json.status == 0) {
                        ...
                        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(6) input').removeAttr('disabled').val(0);
                        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(7) input').removeAttr('disabled').val(0);
                        ...
                        // $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(12) input').prop('disabled', true).val('');
                        // $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(13) input').prop('disabled', true).val('');
                        ...
                        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(12) input').removeAttr('disabled').val(0);
                        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(13) input').removeAttr('disabled').val(0);

                        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(14) input').val(0);
                        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(14) span').html(to_rupiah(0));
    ...
    function HitungTotalBayar() {
        ...
        $('#TabelTransaksi tbody tr').each(function() {
            if ($(this).find('td:nth-child(10) input').val() > 0) {
                ...
                //hitung total ppn11
                var ppn11 = $(this).find('td:nth-child(11) input').val();
                TotalPpn11 = parseInt(TotalPpn11) + parseInt(ppn11)

                //hitung total pph22
                var pph21 = $(this).find('td:nth-child(12) input').val();
                TotalPph21 = parseInt(TotalPph21) + parseInt(pph21)

                //hitung total pph23
                var pph23 = $(this).find('td:nth-child(13) input').val();
                TotalPph23 = parseInt(TotalPph23) + parseInt(pph23)

                //hitung netto
                var netto = $(this).find('td:nth-child(14) input').val();
                TotalNetto = parseInt(TotalNetto) + parseInt(netto)

                //hitung total diskon
                var diskon = $(this).find('td:nth-child(15) span input').val();
                TotalDiskon = parseInt(TotalDiskon) + parseInt(diskon)
                //TotalDiskon = (Math.floor(((parseInt(TotalDiskon) + parseInt(diskon)).toFixed(0)) / 1000) * 1000);

                //nettoBayar = (Math.floor((TotalNetto - TotalDiskon) / 100)*100);
    ...
    $(document).on('change', '#checkbox_ppn_barang', function() {
        ...
        var Harga = $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(8) input').val();
        var JumlahBeli = $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(9) input').val();
        ...
        if (SubTotal > 0) {
            ...
            if ($(this).prop('checked') == true) {
                ...
                $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(12) input').val(0);
                $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(12) input').attr('checked', false);;
            } else {
                checked = false;
    ...
    $(document).on('change', '#checkbox_pph21_barang', function() {
        ...
        if (SubTotal > 0) {
            //var ppn11 = parseFloat(SubTotal * (100/111) * (11/100));
            var ppn11 = parseInt($('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(11) input').val());
            var TotalDenganPajak = (SubTotal - ppn11);
            ...
            if ($(this).prop('checked') == true) {
                checked = true;
                $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(12) input').val(pajakVal);
            } else {
                checked = false;
    ...
    $(document).on('change', '#checkbox_pph23_barang', function() {
        ...
        if (SubTotal > 0) {
            ...
            if ($(this).prop('checked') == true) {
                checked = true;
                $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(13) input').val(pajakVal);
            } else {
                checked = false;
    ...
    function hitungHargaDenganPajak(Indexnya, checked, SubTotal){
        if(SubTotal > 0){
            var ppn11 = parseInt($('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(11) input').val());
            var pph21 = parseInt($('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(12) input').val());
            var pph23 = parseInt($('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(13) input').val());
            ...
            //harga diskon
            $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(15) input').val(0);
            $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(16) input').val(hargaDenganPajak.toFixed(0));
            $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(16) span').html(to_rupiah(hargaDenganPajak));
    ...
    $(document).on('keyup', '#diskon_barang', function() {
        ...
        if (parseFloat(DiskonBarang) > 0) {
            ...
            //HargaSetelahDiskon = (Math.floor(((HargaSetelahPajak - nominalDiskon).toFixed(0)) / 100) * 100);
        } 

        // $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(15) span input').val(nominalDiskon.toFixed(0));
        // $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(16) input').val(HargaSetelahDiskon.toFixed(0));
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(15) span input').val(nominalDiskon);
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(16) input').val(HargaSetelahDiskon);
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(16) span').html(to_rupiah(HargaSetelahDiskon));
    ...
    function SimpanTransaksi() {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/pesanan/edit_nonbuku/'.$jenis_sp.'/'.$id_pesanan_m); ?>",
            type: "POST",
            cache: false,
            data: FormData,
            dataType: 'json',
            success: function(data) {
                if (data.status == 1) {
                    ...
                    $('#ModalFooter').html("<button type='button' class='btn btn-primary' data-dismiss='modal' autofocus>Ok</button>");
                    $('#ModalGue').modal('show');
                    window.location.href = "<?php echo site_url('admin/pesanan/non_buku'); ?>";
