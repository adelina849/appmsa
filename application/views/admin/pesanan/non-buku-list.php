...
<div class="block full">
    ...
    <div class="block-title">
        <div class="block-options pull-right" style="margin-right: 15px;">
            <a href="<?= site_url('admin/pesanan/form_nonbuku'); ?>" class="btn btn-alt btn-sm themed-color-autumn btn-default" data-toggle="tooltip" title="Input surat pesanan baru">
                <i class="fa fa-plus-circle"></i> Input SP Non-Buku
            </a>
        </div>
        ...
        <div class='col-lg-12' style="margin-bottom: 5px;">
            <div class="table-responsive">
                <table id="table_pesanan" class="display table table-vcenter table-condensed table-bordered table-hover" cellspacing="0" width="100%">
                    <thead>
                        <tr class="themed-color themed-background-autumn" style="font-weight: bold;">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table_pesanan').DataTable({
            ...
            "ajax": {
                url: "<?php echo site_url('admin/pesanan/ajax_list_pesanan/non-buku') ?>",
                data: {
