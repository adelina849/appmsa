...
<div class="block full">
    ...
    <div class="block-title">
        ...
        <h2><i class="gi gi-inbox_in"></i> <strong><?= $title; ?></strong></h2>
    </div>
    ...
    <div class="row">
        ...
        <div class='col-sm-10'>
            <p class="text-muted">
                Klik menu <i class="fa fa-eye fa-fw animation-pulse text-info"></i> 
               <strong> Detail Penerimaan Barang</strong> Berdasarkan tanggal input penerimaan                
            </p>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#do').dataTable( {
            ...
            "ajax": {
                url: "<?php echo site_url('admin/penerimaan/all_penerimaan') ?>",
                data: {
